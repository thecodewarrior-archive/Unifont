...
public class Emulator {
	...
	private Shape concretePointsToShape(ArrayList a_listOfPoints) {
		GeneralPath retval = new GeneralPath();
		EContourPoint p;
	...
	private ArrayList createConcretePoints(ArrayList a_points) {
    ...
    private ArrayList createAdjustedPoints(EContour a_contour, int a_ppem) {
        ArrayList retval = new ArrayList();
	...
	private ArrayList promoteAdjustedToMain(ArrayList a_points) {
	    ArrayList retval = new ArrayList();
	    for (int i = 0; i < a_points.size(); i++) {
	...
	private void interpolate(ArrayList a_points, boolean a_isX) {
	...
	private Collection sortPoints(ArrayList a_points, boolean a_isX) {
	...
	private void shiftPoint(EContourPoint a_point, ArrayList a_points, boolean a_isX) {
	...
	private EContourPoint closestTouchedPoint(EContourPoint a_point, ArrayList a_points) {
