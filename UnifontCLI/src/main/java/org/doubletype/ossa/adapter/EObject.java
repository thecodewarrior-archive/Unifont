...
public abstract class EObject {	
	...
	private static GlyphDisplay s_display = null;
	private static ActiveList s_actives = null;
	
	static GlyphDisplay getDisplay() {
		if (s_display == null) {
			s_display = Engine.getSingletonInstance().getDisplay();
		} // if
	...
	static Shape toShape(XPoint2d a_point, AffineTransform a_trans) {
		...
		double e = 3 / getDisplay().getDisplayRatio();
		Point2D source, dest;
